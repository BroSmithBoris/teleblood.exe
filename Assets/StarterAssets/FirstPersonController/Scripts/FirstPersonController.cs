...
namespace StarterAssets
{
	...
	public class FirstPersonController : MonoBehaviour
	{
		...
		[Tooltip("Pickup Physics  Parameters settings")]
		...
		private void Pickup()
		{
			if (_input.pickupDrop)
			{
				if (_heldObj == null)
				{
					if (Physics.Raycast(_mainCamera.transform.position, _mainCamera.transform.TransformDirection(Vector3.forward), out var hit,
						    pickupRange))
					{
